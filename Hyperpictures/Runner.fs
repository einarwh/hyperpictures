...
let functionDictionary : System.Collections.Generic.IDictionary<string, Function> = dict [
    ...
    ("turn-left", transformFunction "turn-left" turn)
    ("turn-right", transformFunction "turn-right" turnCcw)
    ...
    ("below", pairCombinatorFunction "below" below) 
    ("left-of", pairCombinatorFunction "left-of" leftOf) 
    ("right-of", pairCombinatorFunction "right-of" rightOf) 
    ("over", pairCombinatorFunction "over" over)
    ("above-ratio", weightedPairCombinatorFunction "above-ratio" aboveRatio) 
    ("below-ratio", weightedPairCombinatorFunction "below-ratio" belowRatio) 
    ("left-of-ratio", weightedPairCombinatorFunction "left-of-ratio" leftOfRatio) 
    ("right-of-ratio", weightedPairCombinatorFunction "right-of-ratio" rightOfRatio) 
